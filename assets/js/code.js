$( document ).ready(function() {
    ...
    $("body").on("click",".bmiddle .bbtm",function(e){
        e.preventDefault();
        $('footer span.success').fadeIn(0);
        $('footer span.message').fadeOut(0);
    });
    $("body").on("click",".modal-form .bbtm",function(e){
        e.preventDefault();
    ...
    if ($(window).width() < 901) {
        ...
        $( "path" ).hover(
            function() {
                var id = $(this).attr('id');
                $('#show-' + id).fadeIn();
                $('.svg .big-circle,.svg  .circle-line2').fadeIn(0).addClass('animated zoomIn').animate({opacity: 1}, 0,  function () {
                    $('.svg .border-2').fadeIn(0).addClass('border2-an').animate({opacity: 1}, 500,  function () {
                        $('.svg .border-1').fadeIn(0).addClass('border-1-an').animate({opacity: 1}, 500,  function () {
                            $('.svg .circle-line').fadeIn(0).addClass('animated zoomIn').animate({opacity: 1}, 500,  function () {
                                $('.svg .text').fadeIn(0).addClass('animated fadeIn');
                            });
                        });
                    });
                });
                ...
                var id = $(this).attr('id');
                $('#show-' + id).fadeOut();
                $('.svg  .big-circle,.svg  .circle-line2').fadeOut(0).css('opacity', '0').removeClass('animated zoomIn');
                $('.svg .border-2').fadeOut(0).css('opacity', '0').removeClass('border2-an');
                $('.svg .border-1').fadeOut(0).css('opacity', '0').removeClass('border-1-an');
                $('.svg .circle-line').css('display', 'none').css('opacity', '0').removeClass('animated zoomIn');
                $('.svg .text').fadeOut(0).css('opacity', '0').removeClass('animated fadeIn');
            }
        );
    ...
    $(window).scroll(function() {
        ...
        $( ".owl-left, .owl-right" ).hover(
            function() {
                $(this).find("img").attr('src', 'assets/img/part/r.png');
            }, function() {
                $(this).find("img").attr('src', 'assets/img/part/l.png');
            }
        );
}});
