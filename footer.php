...
<footer>
    ...
    <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Af27467eb5c235d962865c364fa46c9d0019f5d8eaa257d3a8ac962a518e3be3b&amp;source=constructor" width="100%" height="100%" frameborder="0"></iframe>
        ...
        <div class="item">
            ...
            <ul class="item1_ul">
                <li class="f_li">
                    <a href="index.php"><img src="assets/img/m_logo.png"></a>
                </li>
                <li>
                    <div class="align-top">
                ...
                <li>
                    <div class="align-top">
                        <img src="assets/img/mail.png" class="i-marg">
                    </div>
...
<script type="text/javascript" src="assets/js/owl-slider.js"></script>
